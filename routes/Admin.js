...
router.get('/all-admin', authentication,  async (req, res) =>{
   try {
...
router.put('/update/:id', authentication, verifyRoles(roles_list[0]), async (req, res) => {
...
router.delete('/:email', authentication, verifyRoles(roles_list[0]), async (req, res) =>{
